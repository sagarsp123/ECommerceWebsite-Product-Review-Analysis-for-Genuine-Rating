                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <a href="registration.aspx" class="btn_3">Create an Account</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                        ...
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                <div class="col-md-12 form-group p_star">
                                     ...
                                     <asp:TextBox ID="txtusername" runat="server" class="form-control" placeholder="Emai Id"></asp:TextBox>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <asp:Button ID="btnlogin" runat="server" Text="Log in" class="btn_3" OnClick="btnlogin_Click"></asp:Button>
